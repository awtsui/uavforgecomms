...
set(MSG_I_FLAGS "-Iexample:/home/alvin/catkin_ws/src/example/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/alvin/catkin_ws/src/example/msg/Telemetry.msg" NAME_WE)
add_custom_target(_example_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example" "/home/alvin/catkin_ws/src/example/msg/Telemetry.msg" ""
)
...
_generate_msg_cpp(example
  "/home/alvin/catkin_ws/src/example/msg/Telemetry.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/example)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/example\")")
  # install generated code
  install(
